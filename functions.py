...
def data_transform(columns, json):
  ...
  request.at['client', 'DebtRatio'] = (json['loan_amount'] / json['loan_term']) / (json['month_profit'] - json['month_expense'])
  if json['gender'] == 0:
  ...
  ohe_data = [json['education'], json['employment_status'], json['family_status'], json['merch_code'], json['goods_category']]
